...
Do note though: my grades aren't as close to that A, and in this blogging venue, I'll certainly [commit
many more mistakes](https://youtube.com/embed/dvKeCcxD3rQ?start=14&end=29). Feel free to [reach out](mailto:omarmsqt@gmail.com) if you spot any!
...
{% highlight c %}
{% include_absolute projects/graphs/graph.c, 145-152 %}
        }
{% endhighlight %}
...
{% highlight c %}
{% include_absolute projects/graphs/graph.c, 153-162 %}
{% endhighlight %}

After the branching is done, the actual traversal in the vertice's adjacency list begins:
{% highlight c %}
{% include_absolute projects/graphs/graph.c, 164-175 %}
                // allocation check and pointer assignment...
{% include_absolute projects/graphs/graph.c, 183-187 %}
{% endhighlight %}
...
---
<br>
Kruskal is a [greedy algorithm](https://en.wikipedia.org/wiki/Greedy_algorithm), and as such, it works heuristically by picking 
...
{% highlight c %}
{% include_absolute projects/graphs/graph.c, 196-204 %}
    .......
}
{% endhighlight %}
...
{% highlight c %}
{% include_absolute projects/graphs/graph.c, 210-218 %}
{% endhighlight %}
